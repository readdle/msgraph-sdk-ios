...
typedef void (^MSGraphDirectoryRoleMembersCollectionReferencesCompletionHandler)(MSGraphDirectoryObjectCollection* response, MSGraphDirectoryRoleMembersCollectionReferencesRequest *nextRequest, NSError *error);
