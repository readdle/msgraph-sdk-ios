...
typedef void (^MSGraphMailFolderMessagesCollectionCompletionHandler)(MSGraphMessageCollection* response, MSGraphMailFolderMessagesCollectionRequest *nextRequest, NSError *error);
