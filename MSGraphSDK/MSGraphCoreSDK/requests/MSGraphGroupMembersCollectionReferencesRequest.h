...
typedef void (^MSGraphGroupMembersCollectionReferencesCompletionHandler)(MSGraphDirectoryObjectCollection* response, MSGraphGroupMembersCollectionReferencesRequest *nextRequest, NSError *error);
