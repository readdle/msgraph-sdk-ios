...
typedef void (^MSGraphMessageAttachmentsCollectionCompletionHandler)(MSGraphAttachmentCollection* response, MSGraphMessageAttachmentsCollectionRequest *nextRequest, NSError *error);
