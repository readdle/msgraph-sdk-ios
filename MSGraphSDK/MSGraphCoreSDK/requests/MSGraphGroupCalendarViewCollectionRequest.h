...
typedef void (^MSGraphGroupCalendarViewCollectionCompletionHandler)(MSGraphEventCollection* response, MSGraphGroupCalendarViewCollectionRequest *nextRequest, NSError *error);
