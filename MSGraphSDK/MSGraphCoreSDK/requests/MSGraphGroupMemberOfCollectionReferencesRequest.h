...
typedef void (^MSGraphGroupMemberOfCollectionReferencesCompletionHandler)(MSGraphDirectoryObjectCollection* response, MSGraphGroupMemberOfCollectionReferencesRequest *nextRequest, NSError *error);
