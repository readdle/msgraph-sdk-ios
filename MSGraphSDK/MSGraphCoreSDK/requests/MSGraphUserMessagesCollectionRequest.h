...
typedef void (^MSGraphUserMessagesCollectionCompletionHandler)(MSGraphMessageCollection* response, MSGraphUserMessagesCollectionRequest *nextRequest, NSError *error);
