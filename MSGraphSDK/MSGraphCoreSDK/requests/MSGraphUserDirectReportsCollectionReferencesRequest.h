...
typedef void (^MSGraphUserDirectReportsCollectionReferencesCompletionHandler)(MSGraphDirectoryObjectCollection* response, MSGraphUserDirectReportsCollectionReferencesRequest *nextRequest, NSError *error);
