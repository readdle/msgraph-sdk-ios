...
typedef void (^MSGraphDeviceRegisteredOwnersCollectionReferencesCompletionHandler)(MSGraphDirectoryObjectCollection* response, MSGraphDeviceRegisteredOwnersCollectionReferencesRequest *nextRequest, NSError *error);
