...
typedef void (^MSGraphDirectoryRoleMembersCollectionWithReferencesCompletionHandler)(MSGraphDirectoryObjectCollection* response, MSGraphDirectoryRoleMembersCollectionWithReferencesRequest *nextRequest, NSError *error);
