...
typedef void (^MSGraphDriveItemsCollectionCompletionHandler)(MSGraphDriveItemCollection* response, MSGraphDriveItemsCollectionRequest *nextRequest, NSError *error);
